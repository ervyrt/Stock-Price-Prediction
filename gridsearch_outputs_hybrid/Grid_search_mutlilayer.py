...
output_folder = 'grid_search_outputs_multilayer'
if not os.path.exists(output_folder):
    os.makedirs(output_folder)
input_path= 'elemination_outputs/eleminated_data.csv'
...
def create_lstm_model(units, optimizer='Adam', learning_rate=0.001):
    # Initialize the RNN
    model = Sequential([
    ...
    return model
model = KerasRegressor(model=create_lstm_model, verbose=0, learning_rate=0.001, units=128)


OPTIMIZER = ['Adam', 'Nadam', 'RMSprop']
BATCH_SIZE = [64, 128, 256] 
LEARNING_RATE = [0.001, 0.01, 0.1, 0.5]
NODES = [[256, 128, 64],[256, 128, 32] , [128, 64, 32], [128, 64, 16], [64, 64, 32], [64, 32, 16]]
